...
type IotaFS interface {
	...
	List(context.Context, *Prefix) (*Files, error)
...
func (c *iotaFSProtobufClient) List(ctx context.Context, in *Prefix) (*Files, error) {
	ctx = ctxsetters.WithPackageName(ctx, "upload")
	ctx = ctxsetters.WithServiceName(ctx, "IotaFS")
...
func (c *iotaFSJSONClient) List(ctx context.Context, in *Prefix) (*Files, error) {
	ctx = ctxsetters.WithPackageName(ctx, "upload")
	ctx = ctxsetters.WithServiceName(ctx, "IotaFS")
	ctx = ctxsetters.WithMethodName(ctx, "List")
	out := new(Files)
...
func (s *iotaFSServer) serveListJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Files and nil error while calling List. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor0 = []byte{
	...
	,
