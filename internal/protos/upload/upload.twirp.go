...
type IotaFS interface {
	...
	HeadFile(context.Context, *Filename) (*Files, error)
...
func (c *iotaFSProtobufClient) HeadFile(ctx context.Context, in *Filename) (*Files, error) {
	ctx = ctxsetters.WithPackageName(ctx, "upload")
	ctx = ctxsetters.WithServiceName(ctx, "IotaFS")
...
func (c *iotaFSJSONClient) HeadFile(ctx context.Context, in *Filename) (*Files, error) {
	ctx = ctxsetters.WithPackageName(ctx, "upload")
	ctx = ctxsetters.WithServiceName(ctx, "IotaFS")
	ctx = ctxsetters.WithMethodName(ctx, "HeadFile")
	out := new(Files)
...
func (s *iotaFSServer) serveHeadFileJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Files and nil error while calling HeadFile. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
